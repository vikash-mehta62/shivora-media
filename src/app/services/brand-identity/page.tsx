    ...
    <main>
        ...
        <div className="max-w-11/12 mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 badge-bg rounded-full mb-4">
              ...
              <span className="text-sm font-medium badge-text">Brand Identity</span>
            </div>
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
              Brand Identity{" "}
              <span className="heading-primary">Design Services</span>
            </h1>
            <p className="text-xl text-secondary max-w-3xl mx-auto">
              Create a memorable brand identity that resonates with your audience. From logo design to complete brand guidelines, we shape every element of your visual identity.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
            {[
              { icon: TrendingUp, metric: "150+", label: "Brands Created" },
              { icon: Target, metric: "100%", label: "Unique Designs" },
              { icon: Zap, metric: "24-48h", label: "Turnaround Time" },
              { icon: Palette, metric: "500+", label: "Design Assets" }
            ].map((stat, i) => (
      ...
      <section className="py-12 sm:py-16 section-alt">
        <div className="max-w-11/12 mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center mb-12">What's Included in Our Brand Identity Services</h2>
      ...
      <section className="py-12 sm:py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="card rounded-3xl p-10 sm:p-16 text-center shadow-2xl bg-brand-section text-white">
            ...
            <p className="text-lg mb-8 text-baby-blue">Let's create a memorable brand identity that stands out and resonates</p>
