...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative overflow-hidden">
      ...
      <div className="mx-auto max-w-[92%] px-4 sm:px-6 lg:px-8 py-8 sm:py-12 relative z-10">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-10 items-center">
          ...
          <div className={`${mounted ? "animate-slide-up" : "opacity-0"}`}>
            ...
            {/* Description */}
            <p className="text-base text-secondary mb-5 max-w-xl leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-6">
              <a href="#contact" className="px-6 py-3 btn-primary rounded-full font-semibold text-sm inline-flex items-center justify-center gap-2 group">
                Start Your Project
                <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
              </a>
              <a href="#portfolio" className="px-6 py-3 btn-outline rounded-full font-semibold text-sm inline-flex items-center justify-center gap-2">
            ...
            <div className="flex items-center gap-4 flex-wrap">
              <div className="flex items-center gap-2">
                <div className="flex -space-x-2">
                  {[1,2,3,4].map((i) => (
                    <div key={i} className="w-8 h-8 rounded-full bg-brand border-2 border-white dark:border-bg-primary flex items-center justify-center text-white text-xs font-bold">
